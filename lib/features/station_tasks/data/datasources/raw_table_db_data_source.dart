...
abstract class RawTableDBDataSource {
  ...
  Future<List<Model>> getRawTableRows<Model>(
      ...
      [String? requestParams, bool Function(Model)? filterFunction]);
  ...
  Future<ServerModel> addRowToRawTable(String endPoint, ServerModel object,
      ServerModel Function(Map<String, dynamic> modelAsJSON) createModel);

  Future<dynamic> updateRowToRawTable(
      String tableName, dynamic id, ServerModel row);

  Future<dynamic> deleteRowToRawTable(String tableName, dynamic id);
...
class RawTableDBDataSourceImpl implements RawTableDBDataSource {
  ...
  Future<List<Model>> getRawTableRows<Model>(
      String endPoint, Model Function(Map<String, dynamic>) createObject,
      [String? requestParams, bool Function(Model p1)? filterFunction]) async {
  ...
  @override
  Future<ServerModel> addRowToRawTable(
      String endPoint,
      ServerModel object,
      ServerModel Function(Map<String, dynamic> modelAsJSON)
          createModel) async {
    var client = http.Client();
    try {
      String fullUri = uriLink + endPoint;
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        throw ServerException("faild response body : ${response.body}");
      }
    } catch (e) {
  ...
  @override
  Future<void> updateRowToRawTable(String tableName, id, ServerModel row) {
